...
public class Admin extends User {
    ...
    // Pre-loads 100 lots across 5 blocks on startup
    // Block 1: Row Bare | Blocks 2-3: Row Improved (end units at lots 1 & 20) | Block 4: Duplex 2BR | Block 5: Duplex 3BR
    ...
    // Returns false if no property with that ID exists
    ...
    // block=0 matches all blocks; minSqm=0 and maxPrice=0 mean no limit
    ...
    // Builds the full inventory report string shown in the report dialog
